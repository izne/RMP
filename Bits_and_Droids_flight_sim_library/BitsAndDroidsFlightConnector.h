...
int getFuelTankTotalQuantity(){return fuelTankTotalQuantity;};
  ...
  // Added by izne
  long int getFenixA320FCUAlt(){ return fnxFCUAlt; }; // Fenix A320
  long int getIniA310FCUAlt(){ return iniFCUAlt; };   // IniBuilds A310
...
private:
  ...
  // Added by izne
  long int fnxFCUAlt; // Fenix A320
  long int iniFCUAlt; // IniBuilds A310
